...
def main():
    ...
    # Write CardImages.gs into the web app source directory, where the GAS
    # backend's getCardImageMappings() call actually reads it from.
    output_path = os.path.join(parent_dir, "webapp", "CardImages.gs")
